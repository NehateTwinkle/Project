                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Forgot Password<br>OTP page</h3>
                            <%
                            String email=null;
                            ...
                            {
                            	customermodel fmodel=(customermodel)session.getAttribute("UserData");
                            	email=fmodel.getEmail();
                            }
                            %>
                            ...
                            <form class="row contact_form" action="forgotcontroller" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="name" name="EnterOTP" value=""
